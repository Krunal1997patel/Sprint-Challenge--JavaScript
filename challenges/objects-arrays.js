...
console.log(tyrannosaurus.weigth); //700kg
...
*/
const populationTotal = zooAnimals.reduce((prevInx, currInx) =>{ 

 return prevInx += currInx.population }
